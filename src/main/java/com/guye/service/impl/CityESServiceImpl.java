...
//import com.guye.repository.CityESRepository;
...
//
//    @Autowired
//    CityESRepository cityESRepository; // ES 操作类
//
//    @Override
...
//
//        Page<City> cityPage = cityESRepository.search(searchQuery);
...
//                .add(QueryBuilders.matchPhraseQuery("city_name", searchContent),
