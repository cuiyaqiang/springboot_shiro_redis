...
public class JedisClusterUtils {  
     ...
     * 保存失败，返回 false 
     */  
   /* public stat boolean saveNX(String key, String val) {
    ...
    *//** 
     ...
     *//*  
    public stat boolean saveNX(String key, String val, int expire) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat void saveString(String key, String val, int seconds) {
    ...
    *//** 
     * 将自增变量存入缓存 
     *//*  
    public stat void saveSeq(String key, long seqNo) {
    ...
    *//** 
     * 将递增浮点数存入缓存 
     *//*  
    public stat void saveFloat(String key, float data) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat void saveBean(String key, Object obj) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat void saveBean(String key, Object obj, int seconds) {
    ...
    *//** 
     ...
     *            队列大小限制 0：不限制 
     *//*  
    public stat void saveToQueue(String key, String val, long size) {
    ...
    *//** 
     ...
     * @param val 
     *//*  
    public stat void hashSet(String hName, String key, String value) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat Map<Object, Object> hgetAll(String key) {
    ...
    *//** 
     ...
     * @param val 
     *//*  
    public stat <T> void hashSet(String hName, String key, T t) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat <T> T getBean(String key, Class<T> clazz) {
    ...
    *//** 
     ...
     * @return 数据 
     *//*  
    public stat String getString(String key) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat List<String> getFromQueue(String key, long size) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat String popQueue(String key) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat Long getSeqNext(String key) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat Long getSeqNext(String key, long value) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat void getSeqBack(String key) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat Object hashGet(String hName, String key) {
  
        return cacheUtils.redisTemplate.opsForHash().get(hName, key);  
    }  
  
    public stat <T> T hashGet(String hName, String key, Class<T> clazz) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat Double incrFloat(String key, double incrBy) {
    ...
    *//** 
     ...
     * @return 判断是否缓存了 
     *//*  
    public stat boolean isCached(String key) {
    ...
    *//** 
     ...
     * @return 判断是否缓存了 
     *//*  
    public stat boolean hashCached(String hName, String key) {
    ...
    *//** 
     ...
     * @return 判断是否缓存了 
     *//*  
    public stat boolean isMember(String key, String val) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat void delKey(String key) {
    ...
    *//** 
     ...
     * @param seconds 
     *//*  
    public stat void expire(String key, int seconds) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat Set<Object> listSet(String setName) {
    ...
    *//** 
     ...
     * @param value 
     *//*  
    public stat void setSave(String setName, String value) {
    ...
    *//** 
     ...
     * @return 列表 
     *//*  
    public stat Set<Tuple> listSortedsetRev(String key, int start, int end) {
    ...
    *//** 
     ...
     * @return 排名 
     *//*  
    public stat Long getRankRev(String key, String member) {
    ...
    *//** 
     ...
     * @return 分数 
     *//*  
    public stat Double getMemberScore(String key, String member) {
    ...
    *//** 
     ...
     *            成员名称 
     *//*  
    public stat void saveToSortedset(String key, Double score, String member) {
    ...
    *//** 
     ...
     *            成员名称 
     *//*  
    public stat void delFromSortedset(String key, String member) {
        cacheUtils.redisTemplate  
    ...
    *//** 
     ...
     * @param clazz 
     *//*  
    public stat <T> T getBeanFromMap(String key, String field, Class<T> clazz) {
    ...
    *//** 
     ...
     *            成员名称 
     *//*  
    public stat void delFromMap(String key, String field) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat long incr(String key) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat String getCount(String key) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat <T> Long lpush(String key, T value) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat <T> Long lpushx(String key, T value) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat Long llen(String key) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat List<String> lrange(String key, long start, long end) {
    ...
    *//** 
     ...
     * @return 
     *//*  
    public stat String lpop(String key) {
    ...
    *//** 
     ...
     * @param val 
     *//*  
    public stat void hsetnx(String hName, String key, String value) {
    ...
    *//** 
     ...
     * @param val 
     *//*  
    public stat <T> void hsetnx(String hName, String key, T t) {
